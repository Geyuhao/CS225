...
private:
    ...
    //bool contains_same(trienode<T> *pt, AList<T> list, AList<T> path, AList<string> &result, int diff);
    bool contains_extend(trienode<T> *pt, AList<T> list, AList<T> path, AList<string> &result);
    bool contains_prefix(trienode<T> *pt, AList<T> list, AList<T> path, AList<string> &result);
    //bool contains_diff(AList<T> list, AList<string> &result);
